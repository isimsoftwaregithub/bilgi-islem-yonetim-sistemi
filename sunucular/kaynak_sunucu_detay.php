...
<legend class="legend_blue">Sunucu için doküman ekle</legend>

<form action="sunucular/kaynak_ekle_sunucu_detay.php" id="FileUploader" enctype="multipart/form-data" method="post" >
<table>
...
<tr><td></td><td><button type="submit" id="upload_button_blue">Ekle</button> </td></tr>
</table>
<div id="output"></div>
