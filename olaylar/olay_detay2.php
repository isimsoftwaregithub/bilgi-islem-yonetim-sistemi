<script type="text/javascript" >
	 $(document).ready(function()
	{
		 ...
		 $("#ekler").load("olaylar/olay_ek_getir2.php?oid="+<?php echo $_GET["oid"]?>);
	 });
	</script>
...
<thead>
<tr><th><?php echo $row_olay_detay["baslik"]?></th><th class="tarih"><?php echo $row_olay_detay["eklenme_tarihi"]?><p style="cursor:hand;cursor:pointer;" class="olay_ozet" onclick="open_popup('olaylar/olay_guncelle_form.php?oid=<?php echo $row_olay_detay["olay_id"]?>')" ><?php echo $img_guncelle?></p></th></tr>
</thead>
<tbody>
